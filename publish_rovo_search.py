...
images_to_upload = {
    "cover": {
        "local_path": "/Users/jessicapiikkila/.gemini/antigravity/brain/8c9a1b4e-8087-4344-8d25-f2b69ec9ab65/rovo_search_cover_1781217742572.png",
        "fileName": "rovo_search_cover_1781217742572.png"
    },
    "diagram": {
        "local_path": "/Users/jessicapiikkila/.gemini/antigravity/brain/8c9a1b4e-8087-4344-8d25-f2b69ec9ab65/rovo_architecture_diagram_1781217751175.png",
        "fileName": "rovo_architecture_diagram_1781217751175.png"
    },
    "incontent": {
        "local_path": "/Users/jessicapiikkila/.gemini/antigravity/brain/8c9a1b4e-8087-4344-8d25-f2b69ec9ab65/troubleshooting_engineer_1781217765531.png",
        "fileName": "troubleshooting_engineer_1781217765531.png"
    }
}
...
def publish_post(uploaded_images):
    md_path = "/Users/jessicapiikkila/Documents/kordic-ai-agent/output_articles/Whitepaper/The_Enterprise_Taxonomy__Breaking_Knowledge_Silos_with_Rovo_Search.md"
    ...
    # We substitute:
    # 1. ![Rovo SaaS Search Cover](rovo_search_cover_1781217742572.png)
    # 2. ![Atlassian Rovo Architecture Blackboard](rovo_architecture_diagram_1781217751175.png)
    # 3. ![Troubleshooting Developer Workstation](troubleshooting_engineer_1781217765531.png)
    new_content = content
    new_content = new_content.replace("![Rovo SaaS Search Cover](rovo_search_cover_1781217742572.png)", f"![Rovo SaaS Search Cover]({wix_cover_url})")
    new_content = new_content.replace("![Atlassian Rovo Architecture Blackboard](rovo_architecture_diagram_1781217751175.png)", f"![Atlassian Rovo Architecture Blackboard]({wix_diagram_url})")
    new_content = new_content.replace("![Troubleshooting Developer Workstation](troubleshooting_engineer_1781217765531.png)", f"![Troubleshooting Developer Workstation]({wix_incontent_url})")
    ...
    # Extract actual article body starting from title '# Stop App-Hopping...'
    start_marker = "# Stop App-Hopping: Blow Up Your SaaS Data Silos with Atlassian Rovo"
    ...
    category_id = "22086586-5103-42ac-af2a-1b5c32b44ef9" # "Atlassian system of work and Rovo"
    tag_labels = ["Atlassian", "Rovo", "Search"]
    ...
    post_payload = {
        "draftPost": {
            "title": "Stop App-Hopping: Blow Up Your SaaS Data Silos with Atlassian Rovo",
            "memberId": member_id,
    ...
    if post_res.status_code in (200, 201):
        ...
        try:
            with conn:
                ...
                cursor.execute("""
                    UPDATE articles 
                    SET wix_item_id = ?, local_file_path = ?, status = 'draft', published_at = CURRENT_TIMESTAMP 
                    WHERE title = 'The Enterprise Taxonomy: Breaking Knowledge Silos with Rovo Search'
                """, (wix_item_id, md_path))
